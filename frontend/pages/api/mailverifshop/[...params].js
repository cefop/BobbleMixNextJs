...
export default function handler(req, res) {
    ...
    async function mail() {
        ...
        let toUserAndShop = await transporter.sendMail({
            ...
            text: 'Les informations de votre vapeshop on bien été enregistré. Nous allons vérifier ces informations sous peu, merci',
            html: customerEmail(),
        });
        ...
        let toUAdminers = await transporter.sendMail({
            ...
            text: `l'utilisateur ${userName} avec l'email ${userEmail} à créé un shop. nom du shop: ${shopName}; adresse: ${shopAddress}, ${shopPhone} / ${shopEmail} -- url : http://localhost:3000/api/verifshop/${shopId}`,
