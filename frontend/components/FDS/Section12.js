            ...
            <Table variant="striped" colorScheme="gray">
                ...
                <Tbody>
                    <Tr> 
                        <Td>
                            ...
                            <UnorderedList>
                                <ListItem>Nocif pour les organismes aquatiques, entraîne des effets à long terme. </ListItem>
                                <ListItem>La substance/le mélange ne satisfont pas aux critères de toxicité aiguë pour le milieu aquatique selon l’annexe I du règlement (CE) N° 1272/2008 [CLP].</ListItem>
                            </UnorderedList>
                        </Td>
                    </Tr>
                </Tbody>
                ...
                <Tbody>
                    <Tr>
                        <Td>
                            <UnorderedList>
                                <ListItem>Les susbtances de ce mélange ne remplissent pas les critères PBT/vPvB de REACH annexe XIII</ListItem>
                            </UnorderedList>
                        </Td>
                    </Tr>
                </Tbody>
