            ...
            <Table variant="striped" colorScheme="gray">
                ...
                <Tbody>
                    <Tr>
                        <Td>
                            <UnorderedList>
                                <ListItem>Ce produit est considéré comme non réactif dans des conditions normales d’utilisation.</ListItem>
                            </UnorderedList>
                        </Td>
                    </Tr>
                </Tbody>
                ...
                <Tbody>
                    <Tr>
                        <Td>
                            <UnorderedList>
                                <ListItem>Le produit est chimiquement stable si les conditions de stockage, d’utilisation et les températures préconisées sont respectées</ListItem>
                            </UnorderedList>
                        </Td>
                    </Tr>
                </Tbody>
                ...
                <Tbody>
                    <Tr>
                        <Td>
                            <UnorderedList>
                                <ListItem>Des réactions dangereuses ne se produisent pas si utilisé et stocké correctement.</ListItem>
                            </UnorderedList>
                        </Td>
                    </Tr>
                </Tbody>
